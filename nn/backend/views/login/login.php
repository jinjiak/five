...
<div class="login">
    <div class="box png">				
		...
		<form action="<?= Url::to(['login/login'])?>" method="post">
		<div class="input">
			<div class="log">
				<div class="name">
					<label>用户名</label><input type="text" class="text" placeholder="用户名" name="admin_name" tabindex="1">
				</div>
				<div class="pwd">
					<label>密　码</label><input type="password" class="text" placeholder="密码" name="admin_pwd" tabindex="2">
