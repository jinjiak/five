				...
				<div class="main-wrap">
					...
					<div class="user-address">
						...
						<ul class="am-avg-sm-1 am-avg-md-3 am-thumbnails">
							<?php foreach ($addressdata as $key => $value): ?>							
								<li class="user-addresslist" class="haha" value="<?php echo $value['address_id'] ?>">										
										<p class="new-tit new-p-re">
											<span class="new-txt"><?php echo $value['accept_name'] ?></span>
											<span class="new-txt-rd2"><?php echo $value['tel'] ?></span>
										</p>
										<div class="new-mu_l2a new-p-re">
											<p class="new-mu_l2cw">
												<span class="title">地址：</span>
												<span class="province"><?php echo $value['province']['region_name']; ?></span>省
												<span class="city"><?php echo $value['city']['region_name']; ?></span>市
												<span class="dist"><?php echo $value['area']['region_name']; ?></span>区
												<span class="street"><?php echo $value['address_name'] ?></span>
											</p>
										</div>
										<div class="new-addr-btn">
											<a href="<?= Url::to(['index/address_find','id'=>$value['address_id']]);?>"><i class="am-icon-edit"></i>编辑</a>
											<span class="new-addr-bar">|</span>
											<a href="<?= Url::to(['index/address_del','id'=>$value['address_id']]);?>" class="del"><i class="am-icon-trash"></i>删除</a>
										</div>
									</li>
									...
									<form class="am-form am-form-horizontal">
										...
										<div class="am-form-group">
											...
											<div class="am-form-content">
												<input type="text" id="user-name" class="accept_name" placeholder="收货人">
											</div>
										</div>
										...
										<div class="am-form-group">
											...
											<div class="am-form-content">
												<input id="user-phone" class="tel" placeholder="手机号必填" type="email">
											</div>
										</div>
										<div class="am-form-group">
										...
										<div class="am-form-group">
											...
											<div class="am-form-content">
												<textarea class="" rows="3" id="user-intro" id="" placeholder="输入详细地址"></textarea>
										...
										<div class="am-form-group">
											<div class="am-u-sm-9 am-u-sm-push-3">
												<a class="am-btn am-btn-danger" id="add">保存</a>
