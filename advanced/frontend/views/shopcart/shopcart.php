...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
						...
						<div class="bundle  bundle-last ">
							...
							<div class="bundle-main">
								<ul class="item-content clearfix">
									...
									<li class="td td-op">
										<div class="td-inner">
											<input type="hidden" class="goods_id" name="goods_id" value="1">
											<a title="移入收藏夹" class="btn-fav" id="collection" href="javascript:void(0)">移入收藏夹</a>
								...
								<script type="text/javascript">
									$(function(){
										$('#collection').click(function(){
											...
											$.ajax({
								                type:"post",
								                url:"<?= Url::to(['shopcart/shopcart_add']);?>",
								                data:{
								                  "goods_id":goods_id,
								                },
								                dataType:"json",      
		...
		<!--引导 -->
		<div class="navCir">
			<li><a href="<?= Url::to(['home/home']);?>"><i class="am-icon-home "></i>首页</a></li>
			<li><a href="<?= Url::to(['home/shopcart']);?>"><i class="am-icon-shopping-basket"></i>购物车</a></li>	
			<li class="active"><a href="<?= Url::to(['index/index']);?>"><i class="am-icon-user"></i>我的</a></li>					
		</div>
	</body>
