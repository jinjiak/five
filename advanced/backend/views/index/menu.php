...
<div class="menu-list">
 ...
 <ul>
  <?php foreach ($posts as $key => $v): ?>
    ...
    <li><a href="<?php echo $v['controller']?>/<?php echo $v['action']?>" title="后台用户列表" target="mainCont"><?php echo $v['power_name'] ?></a></li>
...
<!--   <li class="menu-list-title">
  ...
  <li>
   <ul class="menu-children">
    <li><a href="<?= Url::to(['power/power_admin']);?>" title="后台用户列表" target="mainCont">后台用户列表</a></li>
    <li><a href="<?= Url::to(['power/power_tion']);?>" title="权限列表" target="mainCont">权限列表</a></li>
    <li><a href="<?= Url::to(['power/power_list']);?>" title="用户权限列表" target="mainCont">用户权限列表</a></li>
   </ul>
  </li>
  <li class="menu-list-title">
   <span>订单管理</span>
